...
class bargraph3:
    def view():
        ...
        a1=[];a2=[]
        for a in algo:
            cursor.execute("select recall from evaluations where algorithm='"+str(a)+"' and dataset='Testset1' ")
            row = cursor.fetchall()
        ...
        plt.bar(br1, a1, color='r', width=barWidth,
                edgecolor='grey', label='Testset')
        plt.bar(br2, a2, color='pink', width=barWidth,
        ...
        plt.legend()
        plt.savefig('D:\\MAJOR-PROJECT\\Protein Sequences - V2 (2) new\\Protein Sequences - V2 new\\static\\assets\\images\\g3.jpg', dpi = (200))
